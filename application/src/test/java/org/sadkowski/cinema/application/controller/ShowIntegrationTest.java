...
class ShowIntegrationTest extends IntegrationTestBase {
    ...
    @Autowired
    private ShowReadRepository showReadRepository;

    @Autowired
    private ShowWriteRepository showWriteRepository;
    @Test
    void shouldSaveShowWithCorrectData() {
        ...
        Optional<Show> resultInDatabase = showReadRepository.findByShowId(showId);
        ...
        // Clean up
        showWriteRepository.delete(showId);
    }
    ...
    void shouldThrowValidationExceptionIfTryPlaceOnOccupiedPlaceInOneTime() throws InterruptedException {
        ...
        Stream.of(responses)
                ...
                .forEach(showWriteRepository::delete);
    }
    ...
    void shouldRetrieveListOfShowDTOListWhenUseCorrectStart() {
        ...
        //cleanUp
        showWriteRepository.delete(show.showId());
    }
